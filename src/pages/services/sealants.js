...
import BioDur563Highlight from "../../components/sealants-page/BioDur563Highlight";
import BioSeal197Highlight from "../../components/sealants-page/BioSeal197Highlight";
import BioTuff592Highlight from "../../components/sealants-page/BioTuff592Highlight";
...
const SealantsPage = () => {
  ...
  return (
    <Layout pageTitle={t("sealants.pageHeader")}>
        ...
        <div className={classes.contentContainer}>
          ...
          >
            ...
            <FeatureGridItem>
              <Feature
                icon={Radioactive}
                i18nKey="sealants.features.flexible"
              />
            </FeatureGridItem>
          </Grid>
